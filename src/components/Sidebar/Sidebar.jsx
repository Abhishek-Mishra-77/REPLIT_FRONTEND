...
const Sidebar = () => {
    ...
    return (
        <section>
            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-52 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
                <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <ul className="space-y-2">
                        ...
                        ${location?.pathname === '/' ? "bg-gray-200 text-white dark:bg-gray-700" : "hover:bg-gray-200 dark:hover:bg-gray-700"}
                             `}
                        ...
                        ${location?.pathname === '/editor' ? "bg-gray-200 text-white dark:bg-gray-700" : "hover:bg-gray-200 dark:hover:bg-gray-700"}
