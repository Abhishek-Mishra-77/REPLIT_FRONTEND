            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen border-r-2 border-gray-200 dark:border-gray-700 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidenav">
                <div className="overflow-y-auto py-5 px-3 h-full  bg-[#1C2333] dark:border-gray-700">
                    <ul className="space-y-2">
                        <li>
                            <Link to="/" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg border border-transparent dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 active:border-sky-300 group">
                        ...
                        <li>
                            <Link to="/" className="flex items-center text-center p-1 font-normal border text-gray-900 border-gray-200 dark:border-gray-700 rounded-md dark:text-white hover:bg-gray-800 dark:hover:bg-gray-800 group active:border-sky-300">
                        ...
                        <li>
                            <Link
                              ...
                              ${location?.pathname === '/' ? "bg-gray-200 text-white dark:bg-gray-700 border-sky-300" : "hover:bg-gray-200 dark:hover:bg-gray-700"}`}
                            ...
                            >
                                ...
                                <span className="flex-1 ml-3 text-xs text-left whitespace-nowrap">Home</span>
                            </Link>

                        </li>
                        <li>
                            <Link to="/editor" className={`flex items-center p-2 w-full text-base font-normal text-white rounded-lg transition duration-75   group  
                        ${location?.pathname === '/editor' ? "bg-gray-200 text-white dark:bg-gray-700 active:border-sky-300" : "hover:bg-gray-200 dark:hover:bg-gray-700 "}
                             `} aria-controls="dropdown-sales" data-collapse-toggle="dropdown-sales">
                                ...
                                <span className="flex-1 ml-3 text-xs text-left whitespace-nowrap">Repls</span>
                            </Link>

                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 text-xs ml-3 whitespace-nowrap">Deploments</span>
                            </a>
                        </li>
                        <li>
                            <button type="button" className="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-authentication" data-collapse-toggle="dropdown-authentication">
                                ...
                                <span className="flex-1 ml-3 text-xs text-left whitespace-nowrap">Authentication</span>
                            </button>
                        </li>
                    </ul>
