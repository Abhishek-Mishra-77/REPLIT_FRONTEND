                    ...
                    <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-lg max-md:mx-auto w-full max-w-md">
                        <form className="space-y-6">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <span onClick={() => setIsForgot(true)} className="text-blue-500 text-sm cursor-pointer hover:underline">
                                    Forgot password?
                                </span>
                            </div>
                            <div>
                            ...
                            <p className="text-sm text-center">
                                ...
                                <span onClick={() => setIsLogin(false)} className="text-blue-500 cursor-pointer font-semibold hover:underline">
                                    Register here
                                </span>
                            </p>
                        </form>
