                ...
                <div className="flex justify-center items-center gap-6 max-w-6xl w-full">
                    <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 shadow-lg max-md:mx-auto w-full max-w-md">
                        <form className="space-y-6">
                            <div className="mb-8">
                                <h3 className="text-3xl font-extrabold text-blue-500">Sign up</h3>
                            ...
                            <p className="text-sm text-center">
                                have an account? {" "}
                                <span onClick={() => setIsLogin(true)} className="text-blue-500  cursor-pointer font-semibold hover:underline">
                                    Sign in
                                </span>
                            </p>
                        </form>
